...
<?php include "./includes/nav.php"  ?>
  ...
  <div class="container px-4  " >
    <div class="row gx-5  ">
    <?php
   global $restoran_isim;
   global $restoran_il;
   global $restoran_ilçe;
   global $restoran_mahalle;
   global $restoran_img;
   global $restoran_id;
  
$query = "SELECT * from restoranlar INNER JOIN restoranadres on restoranlar.Restoran_Adres_id = restoranadres.Restoran_Adres_id";
        ...
        <div onclick="location.href='restoranOzel.php?bilgi&restoran_id=<?php echo $restoran_id ?>'" class="col-sm-6 pt-5 box "  >
   
          <div class="p-3 border bg-light maindiv  ">
              <?php  echo" <img width='600' class='img  ' src='../admin/images/$restoran_img' alt=image >"; ?>  
             <h2 > &nbsp &nbsp <i class="fas fa-utensils"></i>  <?php echo $restoran_isim ?> &nbsp &nbsp <?php echo "($restoran_tür)" ?> </h2>
